...
let _letsGo = (target, command, attribute, newQueue) => {
  let activeId = null;
...
export const add = (target, attribute) => addToQueue.add(target, attribute, true);
export const remove = (target, attribute) => addToQueue.remove(target, attribute, true);
export const toggle = (target, attribute) => addToQueue.toggle(target, attribute, true);
export const show = target => addToQueue.remove(target, hidden, true);
export const hide = target => addToQueue.add(target, hidden, true);
