/* letsGo v0.2.3 | MIT license | https://letsgojs.com */
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
  typeof define === 'function' && define.amd ? define(factory) :
  (global.letsGo = factory());
  ...
  var tag = function tag(message) {
    return "[LetsGo] " + message;
  };
  ...
  var InternalError = function (_Error) {
    inherits(InternalError, _Error);

    function InternalError(message) {
      var _ref;

      classCallCheck(this, InternalError);
      ...
      return possibleConstructorReturn(this, (_ref = InternalError.__proto__ || Object.getPrototypeOf(InternalError)).call.apply(_ref, [this, message].concat(args)));
    }
  ...
  function raise() {
    ...
    return new (Function.prototype.bind.apply(InternalError, [null].concat(args)))();
  }
  ...
  function prepare(command, target) {
    ...
    var attribute = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : HIDDEN;
    ...
    if (attribute.charAt(0) === '#') {
      ...
      var _attribute$split2 = slicedToArray(_attribute$split, 2);

      attribute = _attribute$split2[0];
      var _attribute$split2$ = _attribute$split2[1];
      value = _attribute$split2$ === undefined ? '' : _attribute$split2$;
    }
    return function () {
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  maxTransitionTime = findAnimateTime(styles.transitionDuration);
  ...
  function validator (command, target, attribute) {
    if (!target) {
      throw raise('missing "target" parameter');
    }
    if (typeof target !== 'string') {
      throw raise('"target" parameter is not a string type');
    }
    if ((command === ADD || command === REMOVE) && !attribute) {
      throw raise('using "add" or "remove" commands must also have an "attribute" parameter');
    }
  }
  ...
  function queue(animation) {
    ...
    var deferred = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : Promise.resolve();
    var cancelled = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;

    if (animation && !cancelled) {
      try {
        validator.apply(undefined, toConsumableArray(animation));
        var prepared = prepare.apply(undefined, toConsumableArray(animation));
        deferred = asyncToGenerator(regeneratorRuntime.mark(function _callee() {
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
    ...
    return _ref2 = {}, defineProperty(_ref2, ADD, function () {
      for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }

      return queue([ADD].concat(args), deferred, cancelled);
    }), defineProperty(_ref2, REMOVE, function () {
      for (var _len2 = arguments.length, args = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
        args[_key2] = arguments[_key2];
      }

      return queue([REMOVE].concat(args), deferred, cancelled);
    }), defineProperty(_ref2, TOGGLE, function () {
      for (var _len3 = arguments.length, args = Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
        args[_key3] = arguments[_key3];
      }

      return queue([TOGGLE].concat(args), deferred, cancelled);
    }), defineProperty(_ref2, 'show', function show(target) {
      return queue([REMOVE, target, HIDDEN], deferred, cancelled);
    }), defineProperty(_ref2, 'hide', function hide(target) {
      return queue([ADD, target, HIDDEN], deferred, cancelled);
    }), _ref2;
  }
